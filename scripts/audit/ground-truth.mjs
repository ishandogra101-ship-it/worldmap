...
export const GROUND_TRUTH = [
  // --- 1400 India: eleven capitals the snapshot gave to the Sultanate of Delhi ---
  { place: "Hampi (Vijayanagara)", lng: 76.46, lat: 15.33, year: 1400,
    expect: ["Vijayanagara"], reject: ["Sultanate of Delhi", "Delhi Sultanate", "Chola", "Pandya"],
    note: "Vijayanagara's own capital, founded 1336." },
  { place: "Gulbarga (Bahmani)", lng: 76.83, lat: 17.33, year: 1400,
    expect: ["Bahmani"], reject: ["Sultanate of Delhi", "Delhi Sultanate"],
    note: "The Bahmanis broke from Delhi in 1347." },
  { place: "Ahmedabad (Gujarat)", lng: 72.58, lat: 23.03, year: 1400,
    expect: ["Gujarat"], reject: ["Sultanate of Delhi", "Delhi Sultanate"],
    note: "Zafar Khan governed independently from 1391." },
  { place: "Gaur (Bengal)", lng: 88.14, lat: 24.87, year: 1400,
    expect: ["Bengal"], reject: ["Sultanate of Delhi", "Delhi Sultanate"],
    note: "Bengal was independent from 1352." },
  { place: "Mandu (Malwa)", lng: 75.40, lat: 22.34, year: 1400,
    expect: ["Malwa"], reject: ["Sultanate of Delhi", "Delhi Sultanate"],
    note: "Malwa declared independence in 1392." },
  { place: "Jaunpur", lng: 82.68, lat: 25.75, year: 1400,
    expect: ["Jaunpur"], reject: ["Sultanate of Delhi", "Delhi Sultanate"],
    note: "The Sharqi sultanate broke away in 1394." },
  { place: "Chittorgarh (Mewar)", lng: 74.63, lat: 24.88, year: 1400,
    expect: ["Mewar", "Rajput"], reject: ["Sultanate of Delhi", "Delhi Sultanate"],
    note: "Mewar never submitted to Delhi." },
  { place: "Cuttack (Orissa)", lng: 85.88, lat: 20.46, year: 1400,
    expect: ["Ganga", "Gajapati", "Orissa", "Kalinga"], reject: ["Sultanate of Delhi", "Delhi Sultanate"],
    note: "The Eastern Gangas held the Kalinga coast; Delhi never did." },
  { place: "Thatta (Sindh)", lng: 67.92, lat: 24.75, year: 1400,
    expect: ["Sindh", "Samma"], reject: ["Sultanate of Delhi", "Delhi Sultanate"],
    note: "The Sammas ruled the lower Indus from 1351." },
  { place: "Madurai", lng: 78.12, lat: 9.93, year: 1400,
    expect: ["Vijayanagara"], reject: ["Sultanate of Delhi", "Delhi Sultanate", "Pandya"],
    note: "Vijayanagara took Madurai in 1378; the Pandyas were long gone." },
  { place: "Delhi", lng: 77.21, lat: 28.61, year: 1400,
    expect: ["Delhi"],
    note: "Timur sacked Delhi in 1398. The sultanate held the Doab and little else — which is the point: it should be here and nowhere else." },
